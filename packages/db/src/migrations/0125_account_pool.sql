CREATE TABLE "account_pool_state" (
	...
	"stop_reason" text,
	"default_rotation_enabled" boolean DEFAULT true NOT NULL,
	"default_health" jsonb,
...
CREATE UNIQUE INDEX "account_pool_state_company_provider_uq" ON "account_pool_state" USING btree ("company_id","provider");--> statement-breakpoint
